...
const formularoInput = document.querySelector('#formulario-cita input[type="submit"]');
...
class AdminCitas {
    ...
    mostrar() {
        ...
        this.citas.forEach(cita => {
            ...
            const copiaCita = structuredClone(cita); //structuredClone saca copia de un objeto dado
            btnEditar.onclick = () => cargarEdicion(copiaCita);
